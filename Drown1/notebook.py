...
account_sid = 'AC8211c48c30ad62439085966924426b75'
auth_token = '5335214915fcc5314e4caefa8eccad87'
...
# MyModel="modelwith_megadata.t7"
# MyModel="data_with_glasses_model.t7"
...
def main():
    while 1:
        ...
        cv2.imwrite(current_dir+'/temp-images/img.jpg',crop) 
